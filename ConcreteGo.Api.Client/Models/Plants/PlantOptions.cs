...
{
    [XmlRoot(ElementName = "PlantQueryRq")]
    public class PlantOptions
    {
        ...
        public bool ShouldSerializeCompanyIDs() => CompanyIDs != null && CompanyIDs.Count > 0;

        [XmlElement(ElementName = "CompanyCode")]
        public List<string>? CompanyCodes { get; set; } = new List<string>();
        public bool ShouldSerializeCompanyCodes() => CompanyCodes != null && CompanyCodes.Count > 0;
